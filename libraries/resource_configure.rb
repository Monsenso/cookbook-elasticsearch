...
class ElasticsearchCookbook::ConfigureResource < Chef::Resource::LWRPBase
  ...
  attribute(:cookbook_elasticsearch_env, kind_of: String, default: 'elasticsearch_fork')

  attribute(:template_jvm_options, kind_of: String, default: 'jvm_options.erb')
  attribute(:cookbook_jvm_options, kind_of: String, default: 'elasticsearch_fork')

  attribute(:template_elasticsearch_yml, kind_of: String, default: 'elasticsearch.yml.erb')
  attribute(:cookbook_elasticsearch_yml, kind_of: String, default: 'elasticsearch_fork')

  attribute(:template_log4j2_properties, kind_of: String, default: 'log4j2.properties.erb')
  attribute(:cookbook_log4j2_properties, kind_of: String, default: 'elasticsearch_fork')
